...
| S_val_sub of s_val * s_val
| S_val_lt of s_val * s_val
| S_val_and of s_val * s_val
| S_val_or of s_val * s_val
| S_val_not of s_val
...
| S_expr_sub of s_expr * s_expr
| S_expr_lt of s_expr * s_expr
| S_expr_and of s_expr * s_expr
| S_expr_or of s_expr * s_expr
| S_expr_not of s_expr
    ...
    (match _UU03c3_2 with
     | S_val_lt (_UU03c3_21, _UU03c3_22) ->
       (&&) (s_val_eqb _UU03c3_11 _UU03c3_21)
         (s_val_eqb _UU03c3_12 _UU03c3_22)
     | _ -> false)
  | S_val_and (_UU03c3_11, _UU03c3_12) ->
    (match _UU03c3_2 with
     | S_val_and (_UU03c3_21, _UU03c3_22) ->
       (&&) (s_val_eqb _UU03c3_11 _UU03c3_21)
         (s_val_eqb _UU03c3_12 _UU03c3_22)
     | _ -> false)
  | S_val_or (_UU03c3_11, _UU03c3_12) ->
    (match _UU03c3_2 with
     | S_val_or (_UU03c3_21, _UU03c3_22) ->
       (&&) (s_val_eqb _UU03c3_11 _UU03c3_21)
         (s_val_eqb _UU03c3_12 _UU03c3_22)
     | _ -> false)
  | S_val_not _UU03c3_3 ->
    (match _UU03c3_2 with
     | S_val_not _UU03c3_4 -> s_val_eqb _UU03c3_3 _UU03c3_4
     | _ -> false)
...
let rec repl_var e x0 e' =
  ...
  | S_expr_sub (e1, e2) ->
    S_expr_sub ((repl_var e1 x0 e'), (repl_var e2 x0 e'))
  | S_expr_lt (e1, e2) -> S_expr_lt ((repl_var e1 x0 e'), (repl_var e2 x0 e'))
  | S_expr_and (e1, e2) ->
    S_expr_and ((repl_var e1 x0 e'), (repl_var e2 x0 e'))
  | S_expr_or (e1, e2) -> S_expr_or ((repl_var e1 x0 e'), (repl_var e2 x0 e'))
  | S_expr_not e0 -> S_expr_not (repl_var e0 x0 e')
...
module Loc_as_DT =
 struct
  ...
  (** val eq_dec : s_loc -> s_loc -> bool **)

  let eq_dec =
    Nat.eq_dec
 end

module SetLoc = Coq_Make(Loc_as_DT)
...
type path_condition = s_val list
...
(** val assume_c_ref :
    heap -> s_ref_c -> string -> (s_val * s_ref_c) option **)
...
(** val assume_c_num :
    heap -> s_ref_c -> string -> (s_val * s_prim_c) option **)
...
let assume_c_num =
  ...
  | S_ref_c_symb s ->
    ...
    then let s' =
         ...
         option_map (fun _UU03c3_0 -> (_UU03c3_0, z))
           (assume_c_fp (MapRefC.elements h) s f (S_val_prim_c z))
    else None
  | _ -> None)
           ...
           (match u with
            | S_ref_c_symb s ->
              let s' =
                ...
                | S_symb_fld (n1, l0) -> S_symb_fld (n1, (app l0 (f :: [])))
              in
              option_map (fun _UU03a3_ -> (S_val_field (s, f,
                s')) :: _UU03a3_) other_H1
            | _ -> None))
...
(** val merge_pc_func :
    (s_val, (path_condition, path_condition) sigT) sigT -> path_condition **)

let rec merge_pc_func x0 =
  let _UU03c3_0 = projT1 x0 in
  let _UU03a3_1 = projT1 (projT2 x0) in
  let _UU03a3_2 = projT2 (projT2 x0) in
  let merge_pc0 = fun _UU03c3_1 _UU03a3_3 _UU03a3_4 ->
    merge_pc_func (ExistT (_UU03c3_1, (ExistT (_UU03a3_3, _UU03a3_4))))
  in
  (match _UU03a3_1 with
   | [] ->
     (match _UU03a3_2 with
      ...
      | _UU03c3_2 :: _UU03a3_2' ->
        (S_val_or (_UU03c3_0,
          _UU03c3_2)) :: (merge_pc0 _UU03c3_0 [] _UU03a3_2'))
   | _UU03c3_1 :: _UU03a3_1' ->
     (match _UU03a3_2 with
      | [] ->
        (S_val_or ((S_val_not _UU03c3_0),
          _UU03c3_1)) :: (merge_pc0 _UU03c3_0 _UU03a3_1' [])
      | _UU03c3_2 :: _UU03a3_2' ->
        if s_val_eqb _UU03c3_1 _UU03c3_2
        then _UU03c3_1 :: (merge_pc0 _UU03c3_0 _UU03a3_1' _UU03a3_2')
        else (S_val_or ((S_val_not _UU03c3_0),
               _UU03c3_1)) :: (merge_pc0 _UU03c3_0 _UU03a3_1' _UU03a3_2)))

(** val merge_pc :
    s_val -> path_condition -> path_condition -> path_condition **)

let merge_pc _UU03c3_0 _UU03a3_1 _UU03a3_2 =
  merge_pc_func (ExistT (_UU03c3_0, (ExistT (_UU03a3_1, _UU03a3_2))))
         ...
         | S_ref_c_symb s ->
           ...
           then (match class_with_field p0 f with
                 | Some c0 ->
                   ...
                   let cl1 = S_val_not (S_val_eq ((S_val_ref_c y0),
                     (S_val_ref_c S_ref_c_null)))
                   in
                   let cl2 = S_val_subtype ((S_val_ref_c y0), (S_ty_class c1))
                   in
                          ...
                          | Some c' ->
                            (match fdecl c' f with
                             | Some f0 ->
                               ...
                               then (match assume_c_num h y0 f with
                                     | Some p1 ->
                                       ...
                                       (match s3 with
                                        ...
                                        | _ -> None)
                                     | None -> None)
                               else (match assume_c_ref h y0 f with
                                     | Some p1 ->
                                       let (_UU03c3_0, s3) = p1 in
                                       (match s3 with
                                        | S_ref_c_symb s' ->
                    ...
                    | None ->
                      (match class_with_field p0 f with
                       | Some c' ->
                         ...
                         let h' = repl_obj h y0 o' in
                         let cl = S_val_subtype ((S_val_ref_c y0),
                           (S_ty_class c'0))
                         in
              ...
              then (match class_with_field p0 f with
                    | Some c0 ->
                      ...
                      let cl1 = S_val_not (S_val_eq ((S_val_ref_c y0),
                        (S_val_ref_c S_ref_c_null)))
                      in
                      let cl2 = S_val_subtype ((S_val_ref_c y0), (S_ty_class
                        c1))
                      in
                      let _UU03a3_' = app _UU03a3_ (cl1 :: (cl2 :: [])) in
                      Some (h', _UU03a3_')
...
| S_expr_or (e1, e2) ->
  (match e1 with
   | S_expr_val _ -> rstep_c p0 h _UU03a3_ e2
   | _ -> rstep_c p0 h _UU03a3_ e1)
| S_expr_not e1 -> rstep_c p0 h _UU03a3_ e1
| S_expr_eq (e1, e2) ->
  (match e1 with
   | S_expr_val _ -> rstep_c p0 h _UU03a3_ e2
   | _ -> rstep_c p0 h _UU03a3_ e1)
               ...
               | p2 :: l0 ->
                 ...
                 (match s with
                  | S_expr_val _UU03c3_1' ->
                    (match l0 with
                     | [] ->
                       let filtered_var1 = rstep_c_star p0 h1' _UU03a3_ e3 in
                       (match filtered_var1 with
                        | Some p4 ->
                          ...
                          (match filtered_var2 with
                           ...
                           | p5 :: l1 ->
                             let (p6, s1) = p5 in
                             let (h', _UU03a3_2') = p6 in
                             (match s1 with
                              | S_expr_val _UU03c3_2' ->
                                (match l1 with
                                 | [] ->
                                   let _UU03a3_' =
                                     merge_pc _UU03c3_0 _UU03a3_1' _UU03a3_2'
                                   in
                                 ...
                                 | Some h' ->
                                   (match filtered_var4 with
                                    | Some _UU03a3_etc ->
                                      let _UU03a3_' =
                                        app
                                          (merge_pc _UU03c3_1 _UU03a3_1'
                                            _UU03a3_2') _UU03a3_etc
                                      in
                                      ((h', _UU03a3_'), e') :: []
                                    | None -> [])
                                 | None -> [])
      ...
      | S_expr_val _UU03c3_0 ->
        (match _UU03c3_0 with
                 ...
                 (match _UU03c3_2 with
                  | S_val_prim_c s1 ->
                    (match s1 with
                     ...
                     | x1 ->
                       let _UU03c3_3 = S_val_prim_c x1 in
                       let e' = S_expr_val (S_val_sub (_UU03c3_1, _UU03c3_3))
                       in
                       ((h, _UU03a3_), e') :: [])
                  | x1 ->
                    let e' = S_expr_val (S_val_sub (_UU03c3_1, x1)) in
                    ((h, _UU03a3_), e') :: [])
               | x1 ->
                 map (fun x2 ->
                   let (p1, e1') = x2 in
                   let (h', _UU03a3_') = p1 in
                   ((h', _UU03a3_'), (S_expr_sub ((S_expr_val _UU03c3_1),
                   e1')))) (cstep_c_fp0 p0 h _UU03a3_ x1))
            | x1 ->
              let _UU03c3_1 = S_val_prim_c x1 in
              (match e2 with
               | S_expr_val _UU03c3_2 ->
                 let e' = S_expr_val (S_val_sub (_UU03c3_1, _UU03c3_2)) in
                 ((h, _UU03a3_), e') :: []
               | x2 ->
                 map (fun x3 ->
                   let (p1, e1') = x3 in
         ...
         | x1 ->
           (match e2 with
            | S_expr_val _UU03c3_2 ->
              let e' = S_expr_val (S_val_sub (x1, _UU03c3_2)) in
              ((h, _UU03a3_), e') :: []
            | x2 ->
              map (fun x3 ->
                let (p1, e1') = x3 in
                let (h', _UU03a3_') = p1 in
                ((h', _UU03a3_'), (S_expr_sub ((S_expr_val x1), e1'))))
                (cstep_c_fp0 p0 h _UU03a3_ x2)))
      | x1 ->
        map (fun x2 ->
          let (p1, e1') = x2 in
          let (h', _UU03a3_') = p1 in
          ((h', _UU03a3_'), (S_expr_sub (e1', e2))))
          (cstep_c_fp0 p0 h _UU03a3_ x1))
   | S_expr_lt (e1, e2) ->
     (match e1 with
      | S_expr_val _UU03c3_0 ->
      ...
      | S_expr_val _UU03c3_0 ->
        (match _UU03c3_0 with
         | S_val_prim_c s ->
           (match s with
                    ...
                    (match _UU03c3_2 with
                     | S_val_prim_c s1 ->
                       (match s1 with
                        ...
                        | x1 ->
                          let _UU03c3_3 = S_val_prim_c x1 in
                          let e' = S_expr_val (S_val_and (_UU03c3_1,
                            _UU03c3_3))
                          in
                          ((h, _UU03a3_), e') :: [])
                     | x1 ->
                       let e' = S_expr_val (S_val_and (_UU03c3_1, x1)) in
                       ((h, _UU03a3_), e') :: [])
                  | x1 ->
                    map (fun x2 ->
                      let (p1, e1') = x2 in
                      let (h', _UU03a3_') = p1 in
                      ((h', _UU03a3_'), (S_expr_and ((S_expr_val _UU03c3_1),
                      e1')))) (cstep_c_fp0 p0 h _UU03a3_ x1))
               | S_bool_false ->
            ...
            | x1 ->
              ...
              (match e2 with
               | S_expr_val _UU03c3_2 ->
                 let e' = S_expr_val (S_val_and (_UU03c3_1, _UU03c3_2)) in
                 ((h, _UU03a3_), e') :: []
               | x2 ->
                 map (fun x3 ->
                   let (p1, e1') = x3 in
         ...
         | x1 ->
           (match e2 with
            | S_expr_val _UU03c3_2 ->
              let e' = S_expr_val (S_val_and (x1, _UU03c3_2)) in
              ((h, _UU03a3_), e') :: []
            | x2 ->
              map (fun x3 ->
                let (p1, e1') = x3 in
                let (h', _UU03a3_') = p1 in
                ((h', _UU03a3_'), (S_expr_and ((S_expr_val x1), e1'))))
                (cstep_c_fp0 p0 h _UU03a3_ x2)))
      | x1 ->
        map (fun x2 ->
          let (p1, e1') = x2 in
          let (h', _UU03a3_') = p1 in
          ((h', _UU03a3_'), (S_expr_and (e1', e2))))
          (cstep_c_fp0 p0 h _UU03a3_ x1))
   | S_expr_or (e1, e2) ->
     (match e1 with
      | S_expr_val _UU03c3_0 ->
        (match _UU03c3_0 with
         | S_val_prim_c s ->
           (match s with
                    ...
                    (match _UU03c3_2 with
                     | S_val_prim_c s1 ->
                       (match s1 with
                        ...
                        | x1 ->
                          let _UU03c3_3 = S_val_prim_c x1 in
                          let e' = S_expr_val (S_val_or (_UU03c3_1,
                            _UU03c3_3))
                          in
                          ((h, _UU03a3_), e') :: [])
                     | x1 ->
                       let e' = S_expr_val (S_val_or (_UU03c3_1, x1)) in
                       ((h, _UU03a3_), e') :: [])
                  | x1 ->
                    map (fun x2 ->
                      let (p1, e1') = x2 in
                      let (h', _UU03a3_') = p1 in
                      ((h', _UU03a3_'), (S_expr_or ((S_expr_val _UU03c3_1),
                      e1')))) (cstep_c_fp0 p0 h _UU03a3_ x1))
               | S_bool_false ->
                 let _UU03c3_1 = S_val_prim_c (S_prim_c_bool S_bool_false) in
                 (match e2 with
            ...
            | x1 ->
              ...
              (match e2 with
               | S_expr_val _UU03c3_2 ->
                 let e' = S_expr_val (S_val_or (_UU03c3_1, _UU03c3_2)) in
                 ((h, _UU03a3_), e') :: []
               | x2 ->
                 map (fun x3 ->
                   let (p1, e1') = x3 in
         ...
         | x1 ->
           (match e2 with
            | S_expr_val _UU03c3_2 ->
              let e' = S_expr_val (S_val_or (x1, _UU03c3_2)) in
              ((h, _UU03a3_), e') :: []
            | x2 ->
              map (fun x3 ->
                let (p1, e1') = x3 in
                let (h', _UU03a3_') = p1 in
                ((h', _UU03a3_'), (S_expr_or ((S_expr_val x1), e1'))))
                (cstep_c_fp0 p0 h _UU03a3_ x2)))
      | x1 ->
        map (fun x2 ->
          let (p1, e1') = x2 in
          let (h', _UU03a3_') = p1 in ((h', _UU03a3_'), (S_expr_or (e1', e2))))
          (cstep_c_fp0 p0 h _UU03a3_ x1))
   | S_expr_not e1 ->
     (match e1 with
      | S_expr_val _UU03c3_1 ->
            ...
            | S_prim_c_bool s0 ->
              (match s0 with
               ...
               | S_bool_false ->
                 ...
                 ((h, _UU03a3_), e') :: [])
            | x1 ->
              let _UU03c3_2 = S_val_prim_c x1 in
              let e' = S_expr_val (S_val_not _UU03c3_2) in
              ((h, _UU03a3_), e') :: [])
         | x1 ->
           let e' = S_expr_val (S_val_not x1) in ((h, _UU03a3_), e') :: [])
      | x1 ->
        map (fun x2 ->
          let (p1, e1') = x2 in
          let (h', _UU03a3_') = p1 in ((h', _UU03a3_'), (S_expr_not e1')))
          (cstep_c_fp0 p0 h _UU03a3_ x1))
   | S_expr_eq (e1, e2) ->
     (match e1 with
      | S_expr_val _UU03c3_0 ->
        (match _UU03c3_0 with
              ...
              (match e2 with
               ...
               | x1 ->
                 map (fun x2 ->
                   ...
                   e1')))) (cstep_c_fp0 p0 h _UU03a3_ x1))
            | S_ref_c_loc l0 ->
              let _UU03c3_1 = S_val_ref_c (S_ref_c_loc l0) in
              (match e2 with
               | S_expr_val _UU03c3_2 ->
                 (match _UU03c3_2 with
                  | S_val_ref_c s1 ->
                    (match s1 with
                     ...
                     | S_ref_c_loc s ->
                       let e' = S_expr_val (S_val_prim_c (S_prim_c_bool
                         (if Nat.eqb l0 s then S_bool_true else S_bool_false)))
                       in
                       ((h, _UU03a3_), e') :: []
                     | S_ref_c_symb _ ->
                       let e' = S_expr_val (S_val_prim_c (S_prim_c_bool
                  ...
                  | S_val_ref_c s1 ->
                    (match s1 with
                     | S_ref_c_loc _ ->
                       ...
                       ((h, _UU03a3_), e') :: []
                     | x1 ->
                       let _UU03c3_3 = S_val_ref_c x1 in
                       let e' = S_expr_val (S_val_eq (_UU03c3_1, _UU03c3_3))
                       in
                       ((h, _UU03a3_), e') :: [])
                  | x1 ->
         ...
         | S_val_ite (_UU03c3_1, _UU03c3_2, _UU03c3_3) ->
           let _UU03c3_4 = S_val_ite (_UU03c3_1, _UU03c3_2, _UU03c3_3) in
           (match e2 with
            | S_expr_val _UU03c3_5 ->
              (match _UU03c3_5 with
               | S_val_ref_c s ->
                 (match s with
                  | S_ref_c_loc _ ->
                    let e' = S_expr_val (S_val_prim_c (S_prim_c_bool
                    ...
                    ((h, _UU03a3_), e') :: []
                  | x1 ->
                    let _UU03c3_6 = S_val_ref_c x1 in
                    let e' = S_expr_val (S_val_eq (_UU03c3_4, _UU03c3_6)) in
                    ((h, _UU03a3_), e') :: [])
               | x1 ->
                 let e' = S_expr_val (S_val_eq (_UU03c3_4, x1)) in
                 ((h, _UU03a3_), e') :: [])
            | x1 ->
              map (fun x2 ->
                let (p1, e1') = x2 in
                let (h', _UU03a3_') = p1 in
                ((h', _UU03a3_'), (S_expr_eq ((S_expr_val _UU03c3_4), e1'))))
                (cstep_c_fp0 p0 h _UU03a3_ x1))
         | x1 ->
           (match e2 with
            | S_expr_val _UU03c3_2 ->
        ...
        (match _UU03c3_0 with
         | S_val_prim_c s ->
           (match s with
            ...
            | x1 ->
              let _UU03c3_1 = S_val_prim_c x1 in
              let _UU03a3_1' = app _UU03a3_ (_UU03c3_1 :: []) in
              let _UU03a3_2' = app _UU03a3_ ((S_val_not _UU03c3_1) :: []) in
              ((h, _UU03a3_1'), e2) :: (((h, _UU03a3_2'), e3) :: []))
         | x1 ->
           let _UU03a3_1' = app _UU03a3_ (x1 :: []) in
           let _UU03a3_2' = app _UU03a3_ ((S_val_not x1) :: []) in
           ((h, _UU03a3_1'), e2) :: (((h, _UU03a3_2'), e3) :: []))
      | x1 ->
        map (fun x2 ->
          let (p1, e1') = x2 in
                     ...
                     (match filtered_var with
                      | Some s1 ->
                        ...
                        let cl1 = S_val_not (S_val_eq ((S_val_ref_c y0),
                          (S_val_ref_c S_ref_c_null)))
                        in
                        let cl2 = S_val_subtype ((S_val_ref_c y0),
                          (S_ty_class c'))
                        in
                        let _UU03a3_' =
                          app _UU03a3_
                            (app (cl1 :: (cl2 :: []))
                              (map (fun c0 -> S_val_not (S_val_subtype
            ...
            | S_expr_val _UU03c3_' ->
              ...
              app
                (map (fun x1 ->
                  ...
                  let _UU03a3_' = app _UU03a3_1' (_UU03c3_1 :: []) in
                  ((h, _UU03a3_'), e1')) (cstep_c_fp0 p0 h _UU03a3_ e3))
                (map (fun x1 ->
                  let (p1, e2') = x1 in
                  let (_, _UU03a3_2') = p1 in
                  let _UU03a3_' = app _UU03a3_2' ((S_val_not _UU03c3_1) :: [])
                  in
                  ...
                  (alt
                      ...
                      (alt
                        (alt
                          (alt
                            (alt
                              (alt
                                (transform _UU03c3_ (fun x0 -> S_expr_val x0))
                                (and_then (match_token "new") (fun _ ->
                                  transform identifier (fun x0 -> S_expr_new
                                    x0))))
                                ...
                                and_then (match_token "then") (fun _ ->
                                  and_then (expr n') (fun y0 ->
                                    and_then (match_token "else") (fun _ ->
                                      transform (expr n') (fun z -> S_expr_if
                                        (x0, y0, z)))))))))
                    ...
                    (and_then (match_token "(") (fun _ ->
                      and_then (expr n') (fun x0 ->
                        and_then (match_token "<") (fun _ ->
                          and_then (expr n') (fun y0 ->
                            transform (match_token ")") (fun _ -> S_expr_lt
                              (x0, y0))))))))
                  (and_then (match_token "(") (fun _ ->
                    and_then (expr n') (fun x0 ->
                      and_then (match_token "&&") (fun _ ->
                        and_then (expr n') (fun y0 ->
                          transform (match_token ")") (fun _ -> S_expr_and
                            (x0, y0))))))))
                (and_then (match_token "(") (fun _ ->
                  and_then (expr n') (fun x0 ->
                    and_then (match_token "||") (fun _ ->
                      and_then (expr n') (fun y0 ->
                        transform (match_token ")") (fun _ -> S_expr_or (x0,
                          y0))))))))
              (and_then (match_token "(") (fun _ ->
                and_then (match_token "~") (fun _ ->
                  and_then (expr n') (fun x0 ->
                    transform (match_token ")") (fun _ -> S_expr_not x0))))))
            (and_then (match_token "(") (fun _ ->
              and_then (expr n') (fun x0 ->
                and_then (match_token "=") (fun _ ->
                  and_then (expr n') (fun y0 ->
...
| S_val_lt (_UU03c3_1, _UU03c3_2) ->
  append
    (append
      (append (append (from_string "(") (val_to_dstr _UU03c3_1))
        (from_string " < ")) (val_to_dstr _UU03c3_2)) (from_string ")")
| S_val_and (_UU03c3_1, _UU03c3_2) ->
  append
    (append
      (append (append (from_string "(") (val_to_dstr _UU03c3_1))
        (from_string " && ")) (val_to_dstr _UU03c3_2)) (from_string ")")
| S_val_or (_UU03c3_1, _UU03c3_2) ->
  append
    (append
      (append (append (from_string "(") (val_to_dstr _UU03c3_1))
        (from_string " || ")) (val_to_dstr _UU03c3_2)) (from_string ")")
| S_val_not _UU03c3_1 ->
  append (append (from_string "(~") (val_to_dstr _UU03c3_1)) (from_string ")")
              ...
              (append
                (append
                  (append (from_string "(declare-fun ")
                    (from_string (field_name f))) (from_string " (Ref) "))
            ...
            (append
              (append
                (append
                  ...
                  lF)
                (from_string "(declare-sort Ref) ;the sort of references"))
              lF) (from_string "(declare-fun classOf (Ref) SCl)")) lF)
        (from_string "(declare-fun _null () Ref)")) lF)
    (dconcat (from_string "") (map (class_to_dsmt p0) (classes p0)))

(** val value_to_dsmt : s_prg -> s_val -> dstring **)

let rec value_to_dsmt p0 = function
| S_val_unassumed -> from_string ""
| S_val_prim_c p1 -> prim_c_to_dstr p1
| S_val_ref_c u -> ref_c_to_dsmt u
| S_val_add (_UU03c3_1, _UU03c3_2) ->
  append
    (append
      (append (append (from_string "(+ ") (value_to_dsmt p0 _UU03c3_1))
        (from_string " ")) (value_to_dsmt p0 _UU03c3_2)) (from_string ")")
| S_val_sub (_UU03c3_1, _UU03c3_2) ->
  append
    (append
      (append (append (from_string "(- ") (value_to_dsmt p0 _UU03c3_1))
...
| S_val_and (_UU03c3_1, _UU03c3_2) ->
  append
    (append
      (append (append (from_string "(and ") (value_to_dsmt p0 _UU03c3_1))
        (from_string " ")) (value_to_dsmt p0 _UU03c3_2)) (from_string ")")
| S_val_or (_UU03c3_1, _UU03c3_2) ->
  append
    (append
      (append (append (from_string "(or ") (value_to_dsmt p0 _UU03c3_1))
        (from_string " ")) (value_to_dsmt p0 _UU03c3_2)) (from_string ")")
| S_val_not _UU03c3_1 ->
  append (append (from_string "(not ") (value_to_dsmt p0 _UU03c3_1))
    (from_string ")")
| S_val_eq (_UU03c3_1, _UU03c3_2) ->
  append
    (append
  ...
  (match t1 with
   | S_ty_class c0 ->
     append
       (append
         (append
           (append (from_string "(subclass (classOf ")
             (value_to_dsmt p0 _UU03c3_1)) (from_string ") "))
...
| S_val_field (s1, f, s2) ->
  append
    (append
      (append
        (append
          (append (append (from_string "(= (") (from_string f))
            (from_string " ")) (ref_c_to_dsmt (S_ref_c_symb s1)))
        (from_string ") "))
      (match class_with_field p0 f with
       | Some c0 ->
...
| S_val_ite (_UU03c3_1, _UU03c3_2, _UU03c3_3) ->
  append
    (append
      (append
        (append
          (append (append (from_string "(ite ") (value_to_dsmt p0 _UU03c3_1))
            (from_string " ")) (value_to_dsmt p0 _UU03c3_2))
        (from_string " ")) (value_to_dsmt p0 _UU03c3_3)) (from_string ")")

(** val clause_to_dsmt : s_prg -> s_val -> dstring **)

let clause_to_dsmt p0 _UU03c3_0 =
  append (append (from_string "(assert ") (value_to_dsmt p0 _UU03c3_0))
    (from_string ")")
...
| [] -> from_string ""
| _UU03c3_0 :: _UU03a3_' ->
  append (append (clause_to_dsmt p0 _UU03c3_0) lF)
...
let rec add_vars_prim p0 _UU03c3_0 ssPrim =
  ...
  | S_val_or (_UU03c3_1, _UU03c3_2) ->
    add_vars_prim p0 _UU03c3_2 (add_vars_prim p0 _UU03c3_1 ssPrim)
  | S_val_not _UU03c3_1 -> add_vars_prim p0 _UU03c3_1 ssPrim
  | S_val_eq (_UU03c3_1, _UU03c3_2) ->
    add_vars_prim p0 _UU03c3_2 (add_vars_prim p0 _UU03c3_1 ssPrim)
  | S_val_field (_, f, s2) ->
    (match class_with_field p0 f with
...
let rec add_vars_ref p0 _UU03c3_0 ssRef =
  ...
  | S_val_or (_UU03c3_1, _UU03c3_2) ->
    add_vars_ref p0 _UU03c3_2 (add_vars_ref p0 _UU03c3_1 ssRef)
  | S_val_not _UU03c3_1 -> add_vars_ref p0 _UU03c3_1 ssRef
  | S_val_eq (_UU03c3_1, _UU03c3_2) ->
    add_vars_ref p0 _UU03c3_2 (add_vars_ref p0 _UU03c3_1 ssRef)
...
(** val add_vars_loc : s_prg -> s_val -> SetLoc.t -> SetLoc.t **)

let rec add_vars_loc p0 _UU03c3_0 ssLoc =
  match _UU03c3_0 with
  | S_val_ref_c u ->
    (match u with
     | S_ref_c_loc l0 -> SetLoc.add l0 ssLoc
     | _ -> ssLoc)
  | S_val_and (_UU03c3_1, _UU03c3_2) ->
    add_vars_loc p0 _UU03c3_2 (add_vars_loc p0 _UU03c3_1 ssLoc)
  | S_val_or (_UU03c3_1, _UU03c3_2) ->
    add_vars_loc p0 _UU03c3_2 (add_vars_loc p0 _UU03c3_1 ssLoc)
  | S_val_not _UU03c3_1 -> add_vars_loc p0 _UU03c3_1 ssLoc
  | S_val_eq (_UU03c3_1, _UU03c3_2) ->
    add_vars_loc p0 _UU03c3_2 (add_vars_loc p0 _UU03c3_1 ssLoc)
  | S_val_subtype (_UU03c3_1, _) -> add_vars_loc p0 _UU03c3_1 ssLoc
  | S_val_ite (_UU03c3_1, _UU03c3_2, _UU03c3_3) ->
    add_vars_loc p0 _UU03c3_3
      (add_vars_loc p0 _UU03c3_2 (add_vars_loc p0 _UU03c3_1 ssLoc))
  | _ -> ssLoc

(** val declare_vars_clause :
    s_prg -> s_val -> SetSymb.t -> SetSymb.t -> SetLoc.t -> dstring **)

let rec declare_vars_clause p0 _UU03c3_0 ssPrim ssRef ssLoc =
  match _UU03c3_0 with
  | S_val_unassumed -> from_string ""
  | S_val_prim_c p1 ->
    (match p1 with
  ...
  | S_val_ref_c u ->
    (match u with
     | S_ref_c_null -> from_string ""
     | S_ref_c_loc l0 ->
       if SetLoc.mem l0 ssLoc
       then from_string ""
       else append
              (append
                (append (from_string "(declare-fun ")
                  (ref_c_to_dsmt (S_ref_c_loc l0))) (from_string " () Ref)"))
              lF
     | S_ref_c_symb s ->
       ...
       then from_string ""
              ...
              (append
                (append (from_string "(declare-fun ")
                  (ref_c_to_dsmt (S_ref_c_symb s))) (from_string " () Ref)"))
              lF)
  | S_val_add (_UU03c3_1, _UU03c3_2) ->
    append (declare_vars_clause p0 _UU03c3_1 ssPrim ssRef ssLoc)
      (declare_vars_clause p0 _UU03c3_2 (add_vars_prim p0 _UU03c3_1 ssPrim)
        (add_vars_ref p0 _UU03c3_1 ssRef) (add_vars_loc p0 _UU03c3_1 ssLoc))
  | S_val_sub (_UU03c3_1, _UU03c3_2) ->
    append (declare_vars_clause p0 _UU03c3_1 ssPrim ssRef ssLoc)
      (declare_vars_clause p0 _UU03c3_2 (add_vars_prim p0 _UU03c3_1 ssPrim)
        (add_vars_ref p0 _UU03c3_1 ssRef) (add_vars_loc p0 _UU03c3_1 ssLoc))
  ...
  | S_val_or (_UU03c3_1, _UU03c3_2) ->
    append (declare_vars_clause p0 _UU03c3_1 ssPrim ssRef ssLoc)
      (declare_vars_clause p0 _UU03c3_2 (add_vars_prim p0 _UU03c3_1 ssPrim)
        (add_vars_ref p0 _UU03c3_1 ssRef) (add_vars_loc p0 _UU03c3_1 ssLoc))
  | S_val_not _UU03c3_1 -> declare_vars_clause p0 _UU03c3_1 ssPrim ssRef ssLoc
  | S_val_eq (_UU03c3_1, _UU03c3_2) ->
    append (declare_vars_clause p0 _UU03c3_1 ssPrim ssRef ssLoc)
      (declare_vars_clause p0 _UU03c3_2 (add_vars_prim p0 _UU03c3_1 ssPrim)
        (add_vars_ref p0 _UU03c3_1 ssRef) (add_vars_loc p0 _UU03c3_1 ssLoc))
  | S_val_subtype (_UU03c3_1, _) ->
    declare_vars_clause p0 _UU03c3_1 ssPrim ssRef ssLoc
  | S_val_field (s1, f, s2) ->
    append
      (if SetSymb.mem s1 ssRef
       then from_string ""
              ...
              (append
                (append (from_string "(declare-fun ")
                  (ref_c_to_dsmt (S_ref_c_symb s1))) (from_string " () Ref)"))
              lF)
      (match class_with_field p0 f with
       | Some c0 ->
         (match fdecl c0 f with
...
(** val declare_vars :
    s_prg -> path_condition -> SetSymb.t -> SetSymb.t -> SetLoc.t -> dstring **)

let rec declare_vars p0 _UU03a3_ ssPrim ssRef ssLoc =
  match _UU03a3_ with
  | [] -> from_string ""
  | _UU03c3_0 :: _UU03a3_' ->
    append (declare_vars_clause p0 _UU03c3_0 ssPrim ssRef ssLoc)
      (declare_vars p0 _UU03a3_' (add_vars_prim p0 _UU03c3_0 ssPrim)
        (add_vars_ref p0 _UU03c3_0 ssRef) (add_vars_loc p0 _UU03c3_0 ssLoc))

(** val path_condition_to_dsmt : s_prg -> path_condition -> dstring **)

let path_condition_to_dsmt p0 _UU03a3_ =
  append (declare_vars p0 _UU03a3_ SetSymb.empty SetSymb.empty SetLoc.empty)
    (clauses_to_dsmt p0 _UU03a3_)
