...
Compute parse "class Object { } 
class A extends Object { Object f; }
let y0 := Y0 in
let y1 := Y1 in
let foo1 := (y0.f) in
let foo2 := (y1.f) in
...
Definition P17 : s_prg :=  match parse "class Object { } 
class A extends Object { Object f; }
let y0 := Y0 in
let y1 := Y1 in
let foo1 := (y0.f) in
...
Compute step_to_str (step_at P17 0).
Compute step_to_str (step_at P17 1).
Compute step_to_str (step_at P17 2).
Compute step_to_str (step_at P17 3).
Compute step_to_str (step_at P17 4).
Compute step_to_str (step_at P17 5).
Compute step_to_str (step_at P17 6).
Compute step_to_str (step_at P17 7).
Compute step_to_str (step_at P17 8).

Compute parse "class Object { }
(~ (~ false))".

Definition P18 : s_prg :=  match parse "class Object { }
(~ (~ false))" with
| ([], SomeE prg) => prg
| _ => s_prg_l [] (s_expr_var "")
end.

Compute step_to_str (step_at P18 0).
Compute step_to_str (step_at P18 1).
Compute step_to_str (step_at P18 2).
Compute step_to_str (step_at P18 3).
Compute step_to_str (step_at P18 4).
Compute step_to_str (step_at P18 5).
Compute step_to_str (step_at P18 6).
